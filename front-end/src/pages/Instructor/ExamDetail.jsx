...
<div className="screen active" id="exam-detail">
  <div className="home-screen">
    <div className="app-header">
      ...
      <div className="header-right">
        ...
        <div className="home-content" style={{ maxWidth: '960px' }}>
      {loading ? (
      ...
      <div className="breadcrumb">
        ...
        <span>›</span><span className="active"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="svg-icon" ><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg> Chi tiết bài thi</span>
      </div>
      ...
      <div className="exam-detail-header">
        ...
        <div className="header-content-rel">
          ...
          <div className="header-action-group">
            <button onClick={() => navigate('/exams/edit/' + exam.examId)} className="btn-glass"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Chỉnh sửa</button>
